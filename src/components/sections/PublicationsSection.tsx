            ...
            <div className="container mx-auto px-4 max-w-5xl">
                ...
                <div id="dates">
                    ...
                    <div className="flex flex-wrap justify-center gap-6">
                        {[
                            { label: "Paper Submission", date: "10 July 2026", color: "border-indigo-500" },
                            { label: "Acceptance Notification", date: "14 October 2026", color: "border-purple-500" },
                            { label: "Registration & Camera Ready", date: "01 - 15 November 2026", color: "border-green-500" },
                            { label: "Conference Date", date: "14 - 16 December 2026", color: "border-accent", highlight: true },
                        ].map((item, index) => (
